...
<!--
	...
	webFXTreeConfig.rootIcon		= "<c:url value='/images/xtree/blue.png'/>";
	webFXTreeConfig.openRootIcon	= "<c:url value='/images/xtree/blue.png'/>";
	webFXTreeConfig.folderIcon		= "<c:url value='/images/xtree/up.bmp'/>";
	webFXTreeConfig.openFolderIcon	= "<c:url value='/images/xtree/up.bmp'/>";
	webFXTreeConfig.fileIcon		= "<c:url value='/images/xtree/up.bmp'/>";
	...
	var requestLinkUp = "<c:url value='/getGeneralTreeUpSource.op'> <c:param name='taskId' value='${taskId}'/><c:param name='jobId' value='${jobId}'/><c:param name='taskName' value='${taskName}'/> </c:url>";


	var tree = new WebFXLoadTree('(<c:out value='${taskId}'/><c:out value='${taskName}'/>)  <c:out value='${jobId}'/>', requestLinkUp,"");
	document.write(tree);
	document.write("&nbsp;");
