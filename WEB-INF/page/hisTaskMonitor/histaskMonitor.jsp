...
<script type="text/javascript">
  ...
  $(function(){  
	  ...
	  $("#table").datagrid({ 
		...
		pagination:true,
		rownumbers:true,
		url:"<c:url value='/hisTaskMonitor.op' />",
 		fit:true,
		nowrap: true,
		striped: true,
		border : false,
	    ...
	    onClickCell:function(rowIndex,field,value){
	       ...
	       if(field=="TASKNAME"){
	         document.getElementById("detailTaskFrame").src="<c:url value='/hisTaskMonitorDetail.op'/>?batchno="+row.BATCHNO+"&date="+new Date();
...
<div id="detailDialog" title="任务明细"     style="width:1000px;height:450px;background:#eef3fa;">
