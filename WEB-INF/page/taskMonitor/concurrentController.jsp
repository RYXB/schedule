...
<script type="text/javascript">
  ...
  $(function(){          
	  ...
	  $("#table").datagrid({ 
		...
		pagination:true,
		rownumbers:true,
		url:"<c:url value='/concurrentController.op'/>",
		queryParams:{"jobNo":jobNo,"batchdate":batchdate,"taskId":taskId},
 		fit:true,
		nowrap: true,
		striped: true,
		border : false,
      ...
      function statuStyle(value,rec){
        ...
        function doTimeout(){
          ...
          $(panel).panel({ 
             title:"子作业监控列表 -<c:out value='${jobid}'/>(页面将在"+refreshTim+" 秒钟后自动刷新)"
          }); 
          if(refreshTim==0){ 
             doRefresh(); 
             flag=0;
       ...
       function doquery(){ 
          ...
          $("#table").datagrid("load",{"jobNo":jobNo,"batchdate":batchdate,"sunJobNo":sunJobNo,"taskId":taskId,"runstatus":runstatus});
       }
      function doRefresh(){
          var batchdate = document.searchForm.batchdate.value;
          var jobNo = document.searchForm.jobNo.value;
          ...
          var runstatus = $("#Text_runstatus").combobox("getValue");
          var sunJobNo = $("#Text_sunJobNo").val();
          $("#table").datagrid("reload",{"jobNo":jobNo,"batchdate":batchdate,"sunJobNo":sunJobNo,"taskId":taskId,"runstatus":runstatus});
          refreshTim = document.searchForm.refreshTim.value;
          restart();
      }
...
<input type="hidden" name="jobNo" value="<c:out value='${jobid}' />" />  
<input type="hidden" name="taskId" value="<c:out value='${taskNo}' />" />  
<table>  
	<tr class="body">
