...
<table>
	<tr>
		<td class="remark"><img SRC="<c:url value='/images/icon-error.gif' />" WIDTH="18" HEIGHT="13">信息提示</td>
	</tr>
</table>
<br>
<br>
...
<table width="80%" border="0" align="center" cellpadding="5" cellspacing="1" bgcolor="999999">
	...
	<tr>
		...
		<table border="0" cellpadding="0" cellspacing="1">
			<tr>
				<td align="center"><img
					src="<c:url value='/images/icon-warning.gif' />" width="20" height="20"><font
		...
		<table class="top">
			<tr>
				<td align="center">
				   <input name="button22" type="button" class="button2" value="返 回" onclick="javascript:doBack();">
				</td>
			</tr>
		</table>
		</div>
